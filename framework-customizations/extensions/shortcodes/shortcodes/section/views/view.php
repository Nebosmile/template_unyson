...
$customid = ( isset( $atts['customid'] ) && $atts['customid'] ) ?$atts['customid'] : '';
?>
<section id='<?php echo $customid ?>' class="fw-main-row <?php echo $customclass ?> <?php echo esc_attr($section_extra_classes) ?>" <?php echo $section_style; ?> <?php echo $bg_video_data_attr; ?>>
